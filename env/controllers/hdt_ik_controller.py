...
class HDTIKController(Controller):
    """
    Inverse kinematics for the HDT robot, using Pybullet and the urdf description
    files. Loads a hdt robot into an internal Pybullet simulation, and uses it to
    ...
    def setup_inverse_kinematics(self):
        ...
        self.robot_urdf = pjoin(
            self.bullet_data_path, "hdt_angler/hdt_arm.urdf"
        )
