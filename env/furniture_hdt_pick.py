...
class FurnitureHDTPickEnv(FurnitureHDTEnv):
    """
    HDT environment for placing a block onto table.
    """
    ...
    def _step(self, a):
        ...
        ob, _, done, _ = super(FurnitureHDTEnv, self)._step(a)
    ...
    def _reset(self, furniture_id=None, background=None):
        ...
        self._init_qpos = {
            ...
            "hdt_gripper": [0.00373706, 0.00226879],
            "1_block_l": [
                0.04521311,
                0.04596679,
                0.11724173,
        ...
        if self._agent_type in ["Sawyer", "Panda", "Jaco", "HDT"]:
            if (
                "hdt_gripper" in self._init_qpos
...
def main():
    ...
    parser = create_parser(env="FurnitureHDTPickEnv")
    config, unparsed = parser.parse_known_args()

    # generate placing demonstrations
    env = FurnitureHDTPickEnv(config)
