""" Define HDT environment class FurnitureHDTEnv. """
...
class FurnitureHDTEnv(FurnitureEnv):
    """
    HDT environment.
    """
...
def main():
    ...
    # create an environment and run manual control of HDT environment
    env = FurnitureHDTEnv(config)
